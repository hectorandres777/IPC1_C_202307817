...
public class IPC1_C_202307817 {
    public static void main(String[] args) {
        ...
        String[][] historialPeleas = new String[100][3];
        int totalPeleas = 0;
        ...
        do {
            ...
            switch(opcion) {
                ...
                case 6:
                    ...
                    historialPeleas[totalPeleas][0] = fechaHoraPelea;
                    historialPeleas[totalPeleas][1] = personajes[per1][0];
                    historialPeleas[totalPeleas][2] = personajes[per2][0];
                    totalPeleas++;
                    ...
                    break;
                case 7:
                    System.out.println("\n***Has seleccionado: Ver historial de peleas***");
                    ...
                    for (int i = 0; i < totalPeleas; i++) {
                        System.out.println("\nPelea #" + (i + 1));
                        System.out.println("Fecha y hora: " + historialPeleas[i][0]);
                        System.out.println("Personajes: " + historialPeleas[i][1] + " vs " + historialPeleas[i][2]);
                    }
                    break;
                case 8: {
                    System.out.print("""
                            ...
                            Carne: 202307187
                            curso: Laboratorio Introduccion a la Programacion 1, seccion \"C\"
